...
export default class extends Controller {
  static targets = ['openingTime', 'closedTime', 'submit']
  ...
  getOpeningTime(){
    ...
    this.openingTime =  new Date(`2000-01-01 ${openingTimeHr}:${openingTimeMin}:00 +0800`)
    this.compareTime()
  }
  ...
  getClosedTime(){
    ...
    this.closedTime = new Date(`2000-01-01 ${closedTimeHr}:${closedTimeMin}:00 +0800`)
    this.compareTime()
  }
