...
class UsersController < ApplicationController
  ...
  def params_reservation
    params.require(:user).permit(:name, :email, :phone, :gender, :arrival_time, :adult_quantity, :child_quantity, :arrival_date, :end_time).merge(
      seat: @seat, restaurant: @restaurant, user: @user
    )
  end
end
